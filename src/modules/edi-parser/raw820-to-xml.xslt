  ...
  <xsl:template match="/">
    <xsl:element name="remittance-advice" namespace="http://edi4ml/edi/common#">
  ...
  <xsl:template name="BPR">
    ...
    <xsl:element name="begin-payment-remittance" namespace="http://edi4ml/edi/820#">
      <xsl:element name="transaction-handling-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="monetary-amount" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
      <xsl:element name="credit-debit-flag-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=3]"/>
      </xsl:element>
      <xsl:element name="payment-method-code" namespace="http://edi4ml/edi/820#">
  ...
  <xsl:template name="TRN">
    <xsl:param name="segment"/>
    <xsl:element name="trace" namespace="http://edi4ml/edi/820#">
      <xsl:element name="trace-type-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="reference-identification" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template name="DTM">
    <xsl:param name="segment"/>
    <xsl:element name="date-time-reference" namespace="http://edi4ml/edi/820#">
      <xsl:element name="date-time-qualifier" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="date-time" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template name="N1">
    <xsl:param name="segment"/>
    <xsl:element name="party-identification" namespace="http://edi4ml/edi/820#">
      <xsl:element name="entity-identifier-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="name" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
      <xsl:element name="identification-code-qualifier" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=3]"/>
      </xsl:element>
      <xsl:element name="identification-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=4]"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template name="ENT">
    <xsl:param name="segment"/>
    <xsl:element name="entity" namespace="http://edi4ml/edi/820#">
      <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template name="NM1">
    <xsl:param name="segment"/>
    <xsl:element name="entity-name" namespace="http://edi4ml/edi/820#">
      <xsl:element name="entity-identifier-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="entity-type-qualifier" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
      <xsl:element name="last-name" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=3]"/>
      </xsl:element>
      <xsl:element name="first-name" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=4]"/>
      </xsl:element>
      <xsl:element name="middle-initial" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=5]"/>
      </xsl:element>
      <xsl:element name="name-prefix" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=6]"/>
      </xsl:element>
      <xsl:element name="name-suffix" namespace="http://edi4ml/edi/820#">
  ...
  <xsl:template name="RMR">
    ...
    <xsl:element name="remittance-advice" namespace="http://edi4ml/edi/820#">
      <xsl:element name="remittance-identification-qualifier" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="remittance-identification" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
      <xsl:element name="payment-action-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=3]"/>
      </xsl:element>
      <xsl:element name="monetary-amount" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=4]"/>
  ...
  <xsl:template name="REF">
    <xsl:param name="segment"/>
    <xsl:element name="reference-information" namespace="http://edi4ml/edi/820#">
      <xsl:element name="reference-id-qualifier" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="reference-id" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template name="ADX">
    ...
    <xsl:element name="adjustment" namespace="http://edi4ml/edi/820#">
      <xsl:element name="monetary-amount" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="adjustment-reason-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
      <xsl:for-each select="$segments/ex:segment[./@ex:index/number(.) lt $next-index and
        ./@ex:index/number(.) gt number($segment/@ex:index)]">
  ...
  <xsl:template name="NTE">
    <xsl:param name="segment"/>
    <xsl:element name="note" namespace="http://edi4ml/edi/820#">
      <xsl:element name="note-reference-code" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=1]"/>
      </xsl:element>
      <xsl:element name="description" namespace="http://edi4ml/edi/820#">
        <xsl:value-of select="$segment/ex:fields/ex:field[./@ex:index=2]"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
