<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/edi999:implementation-acknowledgement">
    <xsl:element name="edi-document" namespace="http://edi4ml/edi/xml#">
      <xsl:element name="interchanges" namespace="http://edi4ml/edi/xml#">
        <xsl:attribute name="count" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="count(./edi:interchange)"/></xsl:attribute>
  ...
  <xsl:template name="parse-interchange">
    ...
    <xsl:element name="interchange" namespace="http://edi4ml/edi/xml#">
      <xsl:attribute name="start-index" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$interchange/@metadata:start-index"/></xsl:attribute>
      <xsl:attribute name="end-index" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$interchange/@metadata:stop-index"/></xsl:attribute>
      <xsl:element name="control-number" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$interchange/edi:control-number"/></xsl:element>
      <xsl:element name="control-version" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$interchange/edi:control-version"/></xsl:element>
      <xsl:element name="authorization" namespace="http://edi4ml/edi/xml#">
        <xsl:element name="qualifier" namespace="http://edi4ml/edi/xml#">
          <xsl:value-of select="$interchange/edi:authorization/edi:qualifier"/>
        </xsl:element>
        <xsl:element name="information" namespace="http://edi4ml/edi/xml#">
          <xsl:value-of select="$interchange/edi:authorization/edi:information"/>
        </xsl:element>
      </xsl:element>
      <xsl:element name="security" namespace="http://edi4ml/edi/xml#">
        <xsl:element name="qualifier" namespace="http://edi4ml/edi/xml#">
      ...
      <xsl:element name="sender" namespace="http://edi4ml/edi/xml#">
        <xsl:element name="qualifier" namespace="http://edi4ml/edi/xml#">
          <xsl:value-of select="$interchange/edi:sender/edi:qualifier"/>
        </xsl:element>
        <xsl:element name="identifier" namespace="http://edi4ml/edi/xml#">
          <xsl:value-of select="$interchange/edi:sender/edi:identifier"/>
        </xsl:element>
      </xsl:element>
      <xsl:element name="receiver" namespace="http://edi4ml/edi/xml#">
        <xsl:element name="qualifier" namespace="http://edi4ml/edi/xml#">
      ...
      <xsl:element name="interchange-date" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$interchange/edi:format/edi:interchange-date"/>
      </xsl:element>
      <xsl:element name="interchange-time" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$interchange/edi:format/edi:interchange-time"/>
      </xsl:element>
      <xsl:element name="standard-identifier" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$interchange/edi:interchange-standard"/>
      </xsl:element>
      <xsl:element name="acknowledgement-required" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$interchange/edi:acknowledgement-required"/>
      </xsl:element>
      <xsl:element name="usage-indicator" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$interchange/edi:usage"/>
      </xsl:element>
      <xsl:element name="component-separator" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$interchange/edi:format/edi:component-separator"/>
      </xsl:element>
      <xsl:element name="functional-groups" namespace="http://edi4ml/edi/xml#">
  ...
  <xsl:template name="parse-group">
    ...
    <xsl:element name="functional-group" namespace="http://edi4ml/edi/xml#">
      <xsl:attribute name="start-index" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$group/@metadata:start-index"/></xsl:attribute>
      <xsl:attribute name="end-index" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$group/@metadata:stop-index"/></xsl:attribute>
      <xsl:element name="control-number" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:control-number"/>
      </xsl:element>
      <xsl:element name="functional-code" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:functional-code"/>
      </xsl:element>
      <xsl:element name="application-sender" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:sender"/>
      </xsl:element>
      <xsl:element name="application-receiver" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:receiver"/>
      </xsl:element>
      <xsl:element name="date-format" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:date-format"/>
      </xsl:element>
      <xsl:element name="time-format" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:time-format"/>
      </xsl:element>
      <xsl:element name="responsible-agency-code" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:responsible-agency"/>
      </xsl:element>
      <xsl:element name="document-identifier" namespace="http://edi4ml/edi/xml#">
        <xsl:value-of select="$group/edi:document-identifier"/>
      </xsl:element>
      <xsl:element name="transaction-sets" namespace="http://edi4ml/edi/xml#">
        <xsl:attribute name="count" namespace="http://edi4ml/edi/xml#">
  ...
  <xsl:template name="parse-set">
    <xsl:param name="set"/>
    <xsl:element name="transaction-set" namespace="http://edi4ml/edi/xml#">
      <xsl:attribute name="start-index" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$set/@metadata:start-index"/></xsl:attribute>
      <xsl:attribute name="end-index" namespace="http://edi4ml/edi/xml#"><xsl:value-of select="$set/@metadata:stop-index"/></xsl:attribute>
      <xsl:element name="id" namespace="http://edi4ml/edi/xml#">
      ...
      <xsl:element name="segments" namespace="http://edi4ml/edi/xml#">
        <xsl:attribute name="count" namespace="http://edi4ml/edi/xml#">
          <!-- Subtract 2 because the segment count metadata field includes the transaction set start and end segments -->
          <xsl:number value="$set/@metadata:segment-count/number(.) - 2"/>
        </xsl:attribute>
